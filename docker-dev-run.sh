...
PARAMS="$PARAMS -e GITLAB_EMAIL=no-reply@code.mbed.com"
PARAMS="$PARAMS -e GITLAB_GRAVATAR_ENABLED=false"
PARAMS="$PARAMS -e OAUTH_MBED_API_KEY=$OAUTH_MBED_API_KEY"
PARAMS="$PARAMS -e OAUTH_MBED_APP_SECRET=$OAUTH_MBED_APP_SECRET"
